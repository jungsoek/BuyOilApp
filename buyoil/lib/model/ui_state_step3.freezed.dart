...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UIStateStep3);
}
...
/// @nodoc
class $UIStateStep3CopyWith<$Res>  {
$UIStateStep3CopyWith(UIStateStep3 _, $Res Function(UIStateStep3) __);
}


/// Adds pattern-matching-related methods to [UIStateStep3].
extension UIStateStep3Patterns on UIStateStep3 {
...
class UIStateStep3Init implements UIStateStep3 {
  const UIStateStep3Init();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UIStateStep3Init);
}
...
class UIStateStep3CloseDoor implements UIStateStep3 {
  const UIStateStep3CloseDoor();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UIStateStep3CloseDoor);
}
...
class UIStateStep3Completed implements UIStateStep3 {
  const UIStateStep3Completed();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UIStateStep3Completed);
}
